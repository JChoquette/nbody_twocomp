...
{    
  ...
  if(All.ComovingIntegrationOn) 
    ...
    C_max = SAFEFACTOR * 
            ...
            All.CrossSectionInternalMax/pow(All.Time,2)/s_a;
#elif (CROSS_SECTION_TYPE == 1)
    C_max = SAFEFACTOR * 
            BALLINVERSE*(All.DesNumNgb+All.MaxNumNgbDeviation)*
            All.CrossSectionInternalMax/pow(All.Time,2.5)/s_a;
    ...
    C_max = SAFEFACTOR * 
            BALLINVERSE*(All.DesNumNgb+All.MaxNumNgbDeviation)*
            All.CrossSectionInternalMax/pow(All.Time,2.0)*2*All.CrossSectionVelScale/s_a;
